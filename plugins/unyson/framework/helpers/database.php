...
class FW_Db_Options_Model_Settings extends FW_Db_Options_Model
{
    ...
    protected function get_fw_storage_params($item_id, array $extra_data = [])
    {
        return [
            'settings' => true,
        ];
    ...
    protected function _init()
    {
        ...
        function fw_get_db_settings_option(
            ...
            return FW_Db_Options_Model_Settings::_get_instance('settings')->get(
                null,
                $option_id,
                $default_value
            );
...
class FW_Db_Options_Model_Post extends FW_Db_Options_Model
{
        ...
        try {
            ...
            FW_Cache::set(
                ...
                $post_type = get_post_type(
                    ($post_revision_id = wp_is_post_revision(
                        $post_id
                    )) ? $post_revision_id : $post_id
                )
            );
    ...
    protected function get_values($item_id, array $extra_data = [])
    {
        return FW_WP_Meta::get('post', $this->get_post_id($item_id), 'fw_options', []);
    }
    ...
    protected function _init()
    {
        ...
        function fw_get_db_post_option(
            ...
            return FW_Db_Options_Model::_get_instance('post')->get(
                intval($post_id),
                $option_id,
                $default_value
            );
...
class FW_Db_Options_Model_Term extends FW_Db_Options_Model
{
    ...
    public static function _action_fw_delete_term($term_id)
    {
        ...
        $wpdb->delete($table_name, ['fw_term_id' => $term_id], ['%d']);
    }
    ...
    private static function migrate($term_id)
    {
        ...
        if (
            ($old_table_name = self::get_old_table_name()) && ($value = $wpdb->get_col(
                $wpdb->prepare(
            ...
            $wpdb->delete($old_table_name, ['fw_term_id' => $term_id], ['%d']);
    ...
    private static function get_old_table_name()
    {
        if (is_null(self::$old_table_name)) {
            ...
            $table_name = $wpdb->get_results(
                "show tables like '{$wpdb->prefix}fw_termmeta'",
                ARRAY_A
            );
    ...
    protected function _init()
    {
         ...
         * @return mixed|null
         */
        function fw_get_db_term_option(
            $term_id,
            $taxonomy,
            $option_id = null,
            $default_value = null,
            ...
            return FW_Db_Options_Model::_get_instance('term')->get(
                intval($term_id),
                $option_id,
                $default_value,
                [
        ...
        function fw_set_db_term_option($term_id, $taxonomy, $option_id = null, $value)
        {
            ...
            FW_Db_Options_Model::_get_instance('term')->set(
                intval($term_id),
                $option_id,
                $value,
                [
        ...
        add_action('delete_term', [__CLASS__, '_action_fw_delete_term']);
    }
}
...
class FW_Db_Options_Model_Extension extends FW_Db_Options_Model
{
    ...
    protected function get_values($item_id, array $extra_data = [])
    {
        return FW_WP_Option::get('fw_ext_settings_options:' . $item_id, null, []);
    }
    ...
    protected function _init()
    {
         ...
         * @return mixed|null
         */
        function fw_get_db_ext_settings_option(
            $extension_name,
            $option_id = null,
            $default_value = null,
            $get_original_value = null
            ...
            return FW_Db_Options_Model::_get_instance('extension')->get(
                $extension_name,
                $option_id,
                $default_value
            );
        ...
        function fw_set_db_ext_settings_option($extension_name, $option_id = null, $value)
        {
            ...
            FW_Db_Options_Model::_get_instance('extension')->set(
                $extension_name,
                $option_id,
                $value
            );
...
class FW_Db_Options_Model_Customizer extends FW_Db_Options_Model
{
    ...
    protected function get_values($item_id, array $extra_data = [])
    {
        return get_theme_mod('fw_options', []);
    }
    ...
    protected function _init()
    {
        ...
        {
            return FW_Db_Options_Model::_get_instance('customizer')->get(
                null,
                $option_id,
                $default_value
            );
 ...
 */
{
     ...
     * @return mixed|null
     */
function fw_get_db_extension_data(
    $extension_name,
    $multi_key = null,
    $default_value = null,
    $get_original_value = null
